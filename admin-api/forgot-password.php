...
if (mysqli_num_rows($queryResult)>0) {
            ...
            $conn->execute();
            $from = "Expense App <noreply@desired-techs.com>";
            $headers = "From: $from\r\n";
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <a style="color: #ffffff;" href="http://localhost:3000/company/recover-password/' .$verificationCode . '" class="button">Recover password</a>
                            </div>
                        </div>
                </body>
                </html>
