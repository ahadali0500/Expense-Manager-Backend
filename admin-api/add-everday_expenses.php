...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dd = "INSERT INTO `everday_expenses_list`(`name`, `status`,`company_id`) VALUES ('$name','$status','$company_id')";
    $cc = mysqli_query($con, $dd);

    // Check if the insert was successful and return the appropriate response
    if ($cc) {
        http_response_code(200);
        echo json_encode(["message" => "Everyday Expenses added successfully", "code" => 200]);
    } else {
