...
$everyday_expense_id = $_POST['everyday_expense_id'];
...
$everyday_expense_id = mysqli_real_escape_string($con, $everyday_expense_id);

// Build the query with conditional logic
$query = "SELECT * FROM `add-expense` WHERE `expense_type_id`='$expense_type_id' AND `buisness_expense_id`='$buisness_expense_id' AND `everyday_expense_id`='$everyday_expense_id' AND `company_id` = '$company_id'";
